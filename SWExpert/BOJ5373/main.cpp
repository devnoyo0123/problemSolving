...
void rollF1(){
    //앞면을 반시계
    char temp = dice[D][6];
    dice[D][6] = dice[D][7] = dice[D][8] = dice[L][2];
    dice[L][0] = dice[L][3] = dice[L][6] = dice[U][0];
...
void rollF2(){
    ...
    dice[R][2] = dice[R][5] = dice[R][8] = dice[U][2];
...
void rollB1(){
    ...
    dice[R][0] = dice[R][3] = dice[R][6] = dice[D][0];
...
void rollB2(){
    ...
    dice[L][2] = dice[L][5] = dice[L][8] = dice[D][2];
...
void rollL1(){
    //왼쪽면을 반시계
    char temp = dice[D][6];
    dice[D][6] = dice[D][7] = dice[D][8] = dice[F][2];
    dice[F][2] = dice[F][5] = dice[F][8] = dice[U][2];
    dice[U][0] = dice[U][1] = dice[U][2] = dice[B][0];
...
void rollL2(){
    ...
    char temp = dice[D][6];
    dice[D][6] = dice[D][7] = dice[D][8] = dice[F][2];
    dice[F][2] = dice[F][5] = dice[F][8] = dice[U][0];
    dice[U][0] = dice[U][1] = dice[U][2] = dice[B][0];
    dice[B][0] = dice[B][3] = dice[B][6] = temp;
}
...
void rollR1(){
    ...
    dice[U][0] = dice[U][1] = dice[U][2] = dice[B][2];
...
void rollR2(){
    //시계
    char temp = dice[D][6];
    dice[D][6] = dice[D][7] = dice[D][8] = dice[B][2];
    dice[B][2] = dice[B][5] = dice[B][8] = dice[U][2];
    dice[U][0] = dice[U][1] = dice[U][2] = dice[F][0];
...
void rollU1(){
    //윗면을 반시계
    char temp = dice[F][6];
    dice[F][6] = dice[F][7] = dice[F][8] = dice[L][0];
    dice[L][0] = dice[L][3] = dice[L][6] = dice[B][0];
    dice[B][0] = dice[B][1] = dice[B][2] = dice[R][2];
    dice[R][2] = dice[R][5] = dice[R][8] = temp;
}
...
void rollU2(){
    //시계
    char temp = dice[F][6];
    dice[F][6] = dice[F][7] = dice[F][8] = dice[R][2];
    dice[R][2] = dice[R][5] = dice[R][8] = dice[B][2];
    dice[B][0] = dice[B][1] = dice[B][2] = dice[L][0];
    dice[L][0] = dice[L][3] = dice[L][6] = temp;
}
